      ...
      <div className="px-6 py-10 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex h-10 items-center justify-center gap-2 rounded-lg border border-border bg-transparent text-sm font-medium hover:bg-accent transition-colors">
